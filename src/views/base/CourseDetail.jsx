              ...
              <div className="container">
                <div className="row py-5">
                  <div className="col-lg-8">
                    ...
                    <p className="mb-3 dangerouslySetInnerHTML={{__html: `${course?.description?.slice(0, 200)}`}}>"></p>
                    {/* Content */}
                    <ul className="list-inline mb-0">
                      ...
                      <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                        ...
                        {course.student?.length} Enrolled
                      </li>
                      <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                        ...
                        <div className="card shadow p-2 mb-4 z-index-9">
                          ...
                          <div className="card-body px-3">
                            ...
                            <div className="mt-3 d-sm-flex justify-content-sm-between ">
                              ...
                              >
                                <i className="fas fa-spinner fa-spin"></i> Adding To
                                Cart
                              </button>
                              )}
                              <Link
